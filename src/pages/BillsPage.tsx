...
export function BillsPage() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<
    (typeof BILL_CATEGORIES)[0] | null>(null);
            ...
            <form onSubmit={handlePayClick} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#117A3E] focus:border-transparent outline-none font-mono" />
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {BILL_CATEGORIES.map((category) => (
                <button
                  ...
                  className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex flex-col items-center justify-center hover:border-[#117A3E] hover:bg-gray-50 transition-all group">
                  <div
