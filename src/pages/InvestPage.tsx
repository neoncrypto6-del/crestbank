...
const CRYPTO_ASSETS = [
  { name: 'Bitcoin', symbol: 'BTC', price: 67500.0 },
  { name: 'Ethereum', symbol: 'ETH', price: 3450.0 },
  { name: 'Solana', symbol: 'SOL', price: 145.0 },
  { name: 'BNB', symbol: 'BNB', price: 580.0 },
  { name: 'Tether', symbol: 'USDT', price: 1.0 },
  { name: 'USD Coin', symbol: 'USDC', price: 1.0 },
  { name: 'Dogecoin', symbol: 'DOGE', price: 0.15 },
  { name: 'Tron', symbol: 'TRX', price: 0.12 },
  { name: 'XRP', symbol: 'XRP', price: 0.62 },
  { name: 'Litecoin', symbol: 'LTC', price: 85.0 }
];

export function InvestPage() {
  const { user, refreshUser } = useAuth();
  const [selectedAsset, setSelectedAsset] = useState<
    (typeof CRYPTO_ASSETS)[0] | null>(null);
        ...
        {selectedAsset ? (
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full pl-8 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#117A3E] focus:border-transparent outline-none text-lg" />
                </div>
              ...
              <div className="flex space-x-4">
                ...
                <button
                  ...
                  className="flex-1 bg-[#117A3E] hover:bg-[#0e6332] text-white font-semibold py-3 px-6 rounded-lg transition-colors disabled:opacity-70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {CRYPTO_ASSETS.map((asset) => (
              <div
                key={asset.symbol}
                className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex justify-between items-center hover:border-[#117A3E] transition-colors">
                <div>
                ...
                <div className="text-right flex flex-col items-end">
                  ...
                  <button
                    ...
                    className="text-sm bg-green-50 text-[#117A3E] hover:bg-[#117A3E] hover:text-white font-medium py-1.5 px-4 rounded-full transition-colors">
                    Trade
                  </button>
                </div>
              </div>
