...
const DOC_TYPES = [
  ...
  { id: 'ssn', label: 'SSN Document' },
  { id: 'w2', label: 'W2 Document' },
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-6 flex items-center">
            <ShieldCheck className="w-5 h-5 mr-2 text-[#117A3E]" /> Required
            Documents
          </h3>
                ...
                <div
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium flex items-center justify-center w-full md:w-auto ${
                        existingDoc
                          ? 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          : 'bg-green-50 text-[#117A3E] hover:bg-green-100'
                      }`}>
                      {isUploading
                        ? 'Uploading...'
                        : existingDoc
