          ...
          <div className="bg-[#003A70] p-8 flex flex-col items-center justify-center text-white relative">
            <div className="relative mb-4 group">
              ...
              <button
                ...
                disabled={uploading}
                className="absolute bottom-0 right-0 w-10 h-10 bg-[#0060AF] rounded-full border-2 border-white flex items-center justify-center hover:bg-blue-600 transition-colors shadow-md group-hover:scale-110">
            ...
            {uploading &&
            <p className="text-xs text-blue-200 mt-2">Uploading...</p>
            }
          </div>
