...
export function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="w-full bg-[#0060AF] text-white sticky top-0 z-40 shadow-md">
      ...
      <div className="fixed inset-0 z-50">
          ...
          <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-200">
            <div className="bg-[#0060AF] text-white p-4 flex items-center justify-between">
          ...
          <div className="px-4 py-2 border-b border-gray-100 bg-gray-50">
              ...
              className="text-sm text-[#0060AF] font-medium hover:underline">
            ...
            <div className="divide-y divide-gray-100">
              ...
              <div
                key={notif.id}
                className={`p-4 hover:bg-gray-50 transition-colors cursor-pointer ${!notif.read ? 'bg-blue-50/50 border-l-4 border-l-[#0060AF]' : 'border-l-4 border-l-transparent'}`}
                onClick={() => {
                  if (!notif.read) markAsRead(notif.id);
                    ...
                    className={`text-sm ${!notif.read ? 'font-semibold text-gray-900' : 'text-gray-700'}`}>
                        ...
                        {!notif.read &&
                  <span className="w-2 h-2 bg-[#0060AF] rounded-full flex-shrink-0 mt-1.5 ml-2" />
                  }
                      </div>
