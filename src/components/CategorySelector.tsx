    ...
    <section className="w-full py-12 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {visibleCategories.map((category) => {
              ...
              return (
                <a
                  ...
                  <div className="w-16 h-16 rounded-full border-2 border-gray-300 flex items-center justify-center mb-3 group-hover:border-[#0060AF] transition-colors">
                    <Icon
                      className="w-8 h-8 text-gray-600 group-hover:text-[#0060AF] transition-colors"
                      strokeWidth={1.5} />
                    
                  </div>
                  <span className="text-[#0060AF] font-medium text-center text-sm">
                    {category.name}
                  </span>
                </a>);
        ...
        <div className="hidden md:flex items-center justify-center space-x-4 mt-8">
          <button
            onClick={handlePrev}
            className="text-[#0060AF] hover:text-blue-800 p-2 rounded-full hover:bg-blue-50 transition-colors">
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              className="focus:outline-none">
                ...
                <Circle
                className={`w-3 h-3 ${idx === currentPage ? 'fill-[#0060AF] text-[#0060AF]' : 'fill-gray-300 text-gray-300'}`} />
